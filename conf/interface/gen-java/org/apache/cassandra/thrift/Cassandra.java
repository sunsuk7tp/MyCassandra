...
public class Cassandra {
  ...
  public interface AsyncIface {
    ...
    public void insert(String keyspace, String key, ColumnPath column_path, byte[] value, long timestamp, ConsistencyLevel consistency_level, AsyncMethodCallback<AsyncClient.insert_call> resultHandler) throws TException;
  ...
  public static class AsyncClient extends TAsyncClient implements AsyncIface {
    ...
    public void insert(String keyspace, String key, ColumnPath column_path, byte[] value, long timestamp, ConsistencyLevel consistency_level, AsyncMethodCallback<insert_call> resultHandler) throws TException {
      checkReady();
    ...
    public static class insert_call extends TAsyncMethodCall {
      ...
      private ConsistencyLevel consistency_level;
      public insert_call(String keyspace, String key, ColumnPath column_path, byte[] value, long timestamp, ConsistencyLevel consistency_level, AsyncMethodCallback<insert_call> resultHandler, TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.keyspace = keyspace;
        this.key = key;
        this.column_path = column_path;
    ...
    public static class describe_ring_call extends TAsyncMethodCall {
      ...
      public List<TokenRange> getResult() throws TException {
        if (getState() != State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        TMemoryInputTransport memoryTransport = new TMemoryInputTransport(getFrameBuffer().array());
