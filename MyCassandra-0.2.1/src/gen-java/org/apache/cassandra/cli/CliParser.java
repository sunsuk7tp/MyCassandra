// $ANTLR 3.1.3 Mar 18, 2009 10:09:25 /home/nakamura/MyCassandra/MyCassandra-0.2.1/src/java/org/apache/cassandra/cli/Cli.g 2011-06-18 06:46:22
...
public class CliParser extends Parser {
        ...
        try {
            ...
            switch (alt5) {
                case 1 :
                    ...
                    // AST REWRITE
                    // elements: port, host, username, password
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    public final CliParser.columnFamilyExpr_return columnFamilyExpr() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: rowKey, column, super_column, columnFamily
            // token labels: 
